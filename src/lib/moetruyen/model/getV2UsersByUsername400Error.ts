 ...
 */
import type { GetV2UsersByUsername400ErrorDetails } from "./getV2UsersByUsername400ErrorDetails";

export type GetV2UsersByUsername400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2UsersByUsername400ErrorDetails;
};
