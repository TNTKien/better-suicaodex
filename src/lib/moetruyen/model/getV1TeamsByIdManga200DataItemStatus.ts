...
export type GetV1TeamsByIdManga200DataItemStatus =
  (typeof GetV1TeamsByIdManga200DataItemStatus)[keyof typeof GetV1TeamsByIdManga200DataItemStatus];

export const GetV1TeamsByIdManga200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
