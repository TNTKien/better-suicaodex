 ...
 */
import type { GetV2CommentsRecent400ErrorDetails } from "./getV2CommentsRecent400ErrorDetails";

export type GetV2CommentsRecent400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2CommentsRecent400ErrorDetails;
};
