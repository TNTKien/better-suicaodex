 ...
 */
import type { GetV2UsersByUsername200DataTeam } from "./getV2UsersByUsername200DataTeam";

export type GetV2UsersByUsername200Data = {
  /** @minLength 1 */
  username: string;
   ...
   */
  commentCount: number;
  team: GetV2UsersByUsername200DataTeam;
};
