...
export type GetV1CommentsChaptersByIdOrder =
  (typeof GetV1CommentsChaptersByIdOrder)[keyof typeof GetV1CommentsChaptersByIdOrder];

export const GetV1CommentsChaptersByIdOrder = {
  asc: "asc",
  desc: "desc",
} as const;
