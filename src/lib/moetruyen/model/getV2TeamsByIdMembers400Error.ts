 ...
 */
import type { GetV2TeamsByIdMembers400ErrorDetails } from "./getV2TeamsByIdMembers400ErrorDetails";

export type GetV2TeamsByIdMembers400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2TeamsByIdMembers400ErrorDetails;
};
