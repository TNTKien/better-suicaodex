...
export type GetV1ChaptersById200DataChapterAccess =
  (typeof GetV1ChaptersById200DataChapterAccess)[keyof typeof GetV1ChaptersById200DataChapterAccess];

export const GetV1ChaptersById200DataChapterAccess = {
  public: "public",
