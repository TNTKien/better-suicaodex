...
export type GetV2CommentsMangaByIdOrder =
  (typeof GetV2CommentsMangaByIdOrder)[keyof typeof GetV2CommentsMangaByIdOrder];

export const GetV2CommentsMangaByIdOrder = {
  asc: "asc",
  desc: "desc",
} as const;
