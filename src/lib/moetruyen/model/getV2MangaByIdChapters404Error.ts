 ...
 */
import type { GetV2MangaByIdChapters404ErrorDetails } from "./getV2MangaByIdChapters404ErrorDetails";

export type GetV2MangaByIdChapters404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2MangaByIdChapters404ErrorDetails;
};
