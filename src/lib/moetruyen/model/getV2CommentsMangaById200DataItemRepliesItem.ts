 ...
 */
import type { GetV2CommentsMangaById200DataItemRepliesItemAuthor } from "./getV2CommentsMangaById200DataItemRepliesItemAuthor";

export type GetV2CommentsMangaById200DataItemRepliesItem = {
  /**
  ...
  /** @minLength 1 */
  commentPath: string;
  author: GetV2CommentsMangaById200DataItemRepliesItemAuthor;
};
