 ...
 */
import type { GetV2UsersByUsernameComments404ErrorDetails } from "./getV2UsersByUsernameComments404ErrorDetails";

export type GetV2UsersByUsernameComments404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2UsersByUsernameComments404ErrorDetails;
};
