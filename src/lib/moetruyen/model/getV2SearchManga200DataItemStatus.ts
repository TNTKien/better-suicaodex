 ...
 */
export type GetV2SearchManga200DataItemStatus =
  (typeof GetV2SearchManga200DataItemStatus)[keyof typeof GetV2SearchManga200DataItemStatus];

export const GetV2SearchManga200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
