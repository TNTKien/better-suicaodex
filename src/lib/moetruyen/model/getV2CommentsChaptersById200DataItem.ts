 ...
 */
import type { GetV2CommentsChaptersById200DataItemAuthor } from "./getV2CommentsChaptersById200DataItemAuthor";
import type { GetV2CommentsChaptersById200DataItemRepliesItem } from "./getV2CommentsChaptersById200DataItemRepliesItem";

export type GetV2CommentsChaptersById200DataItem = {
  /**
  ...
  /** @minLength 1 */
  commentPath: string;
  author: GetV2CommentsChaptersById200DataItemAuthor;
  replies: GetV2CommentsChaptersById200DataItemRepliesItem[];
};
