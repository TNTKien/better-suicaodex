 ...
 */
import type { GetV2UsersByUsername404ErrorDetails } from "./getV2UsersByUsername404ErrorDetails";

export type GetV2UsersByUsername404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2UsersByUsername404ErrorDetails;
};
