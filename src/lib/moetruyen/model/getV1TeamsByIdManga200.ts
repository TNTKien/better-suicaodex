 ...
 */
import type { GetV1TeamsByIdManga200DataItem } from "./getV1TeamsByIdManga200DataItem";
import type { GetV1TeamsByIdManga200Meta } from "./getV1TeamsByIdManga200Meta";

export type GetV1TeamsByIdManga200 = {
  success: true;
  data: GetV1TeamsByIdManga200DataItem[];
  meta: GetV1TeamsByIdManga200Meta;
};
