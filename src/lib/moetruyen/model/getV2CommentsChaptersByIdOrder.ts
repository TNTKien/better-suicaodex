...
export type GetV2CommentsChaptersByIdOrder =
  (typeof GetV2CommentsChaptersByIdOrder)[keyof typeof GetV2CommentsChaptersByIdOrder];

export const GetV2CommentsChaptersByIdOrder = {
  asc: "asc",
  desc: "desc",
} as const;
