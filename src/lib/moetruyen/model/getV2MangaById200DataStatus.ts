 ...
 */
export type GetV2MangaById200DataStatus =
  (typeof GetV2MangaById200DataStatus)[keyof typeof GetV2MangaById200DataStatus];

export const GetV2MangaById200DataStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
