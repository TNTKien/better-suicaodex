 ...
 */
import type { GetV2ChaptersById403ErrorDetails } from "./getV2ChaptersById403ErrorDetails";

export type GetV2ChaptersById403Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2ChaptersById403ErrorDetails;
};
