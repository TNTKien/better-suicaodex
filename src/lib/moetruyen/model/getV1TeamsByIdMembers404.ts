 ...
 */
import type { GetV1TeamsByIdMembers404Error } from "./getV1TeamsByIdMembers404Error";
import type { GetV1TeamsByIdMembers404Meta } from "./getV1TeamsByIdMembers404Meta";

export type GetV1TeamsByIdMembers404 = {
  success: false;
  error: GetV1TeamsByIdMembers404Error;
  meta: GetV1TeamsByIdMembers404Meta;
};
