 ...
 */
import type { GetV2TeamsByIdUpdates404ErrorDetails } from "./getV2TeamsByIdUpdates404ErrorDetails";

export type GetV2TeamsByIdUpdates404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2TeamsByIdUpdates404ErrorDetails;
};
