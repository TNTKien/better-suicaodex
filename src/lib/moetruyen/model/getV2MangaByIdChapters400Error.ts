 ...
 */
import type { GetV2MangaByIdChapters400ErrorDetails } from "./getV2MangaByIdChapters400ErrorDetails";

export type GetV2MangaByIdChapters400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2MangaByIdChapters400ErrorDetails;
};
