...
export type GetV2ChaptersById200DataChapterAccess =
  (typeof GetV2ChaptersById200DataChapterAccess)[keyof typeof GetV2ChaptersById200DataChapterAccess];

export const GetV2ChaptersById200DataChapterAccess = {
  public: "public",
