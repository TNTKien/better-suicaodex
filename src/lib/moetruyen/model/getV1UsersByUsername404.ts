 ...
 */
import type { GetV1UsersByUsername404Error } from "./getV1UsersByUsername404Error";
import type { GetV1UsersByUsername404Meta } from "./getV1UsersByUsername404Meta";

export type GetV1UsersByUsername404 = {
  success: false;
  error: GetV1UsersByUsername404Error;
  meta: GetV1UsersByUsername404Meta;
};
