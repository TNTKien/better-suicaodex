 ...
 */
import type { GetV1MangaRandom200DataItemGenresItem } from "./getV1MangaRandom200DataItemGenresItem";
import type { GetV1MangaRandom200DataItemStatus } from "./getV1MangaRandom200DataItemStatus";

export type GetV1MangaRandom200DataItem = {
  /**
  ...
  author: string | null;
  status: GetV1MangaRandom200DataItemStatus;
  cover: string | null;
  ...
  chapterCount: number;
  isOneshot: boolean;
  genres: GetV1MangaRandom200DataItemGenresItem[];
};
