 ...
 */
import type { GetV1CommentsChaptersById400ErrorDetails } from "./getV1CommentsChaptersById400ErrorDetails";

export type GetV1CommentsChaptersById400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1CommentsChaptersById400ErrorDetails;
};
