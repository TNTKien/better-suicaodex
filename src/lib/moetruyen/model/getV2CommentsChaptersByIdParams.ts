 ...
 */
import type { GetV2CommentsChaptersByIdOrder } from "./getV2CommentsChaptersByIdOrder";

export type GetV2CommentsChaptersByIdParams = {
  /**
   ...
   */
  order?: GetV2CommentsChaptersByIdOrder;
};
