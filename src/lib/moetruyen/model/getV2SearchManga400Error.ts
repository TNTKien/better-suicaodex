 ...
 */
import type { GetV2SearchManga400ErrorDetails } from "./getV2SearchManga400ErrorDetails";

export type GetV2SearchManga400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2SearchManga400ErrorDetails;
};
