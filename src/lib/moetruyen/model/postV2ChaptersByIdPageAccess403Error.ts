 ...
 */
import type { PostV2ChaptersByIdPageAccess403ErrorDetails } from "./postV2ChaptersByIdPageAccess403ErrorDetails";

export type PostV2ChaptersByIdPageAccess403Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: PostV2ChaptersByIdPageAccess403ErrorDetails;
};
