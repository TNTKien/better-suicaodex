 ...
 */
import type { GetV2CommentsChaptersById400ErrorDetails } from "./getV2CommentsChaptersById400ErrorDetails";

export type GetV2CommentsChaptersById400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2CommentsChaptersById400ErrorDetails;
};
