 ...
 */
import type { GetV2TeamsByIdUpdates200DataItemChapterAccess } from "./getV2TeamsByIdUpdates200DataItemChapterAccess";

export type GetV2TeamsByIdUpdates200DataItemChapter = {
  /**
  ...
  date: string | null;
  pages: number | null;
  access: GetV2TeamsByIdUpdates200DataItemChapterAccess;
  isOneshot: boolean;
