 ...
 */
import type { GetV2MangaByIdChaptersAggregate200DataChaptersItemAccess } from "./getV2MangaByIdChaptersAggregate200DataChaptersItemAccess";

export type GetV2MangaByIdChaptersAggregate200DataChaptersItem = {
  /**
  ...
  title: string | null;
  date: string | null;
  access: GetV2MangaByIdChaptersAggregate200DataChaptersItemAccess;
};
