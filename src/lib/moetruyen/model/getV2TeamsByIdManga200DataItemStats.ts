 ...
 */
export type GetV2TeamsByIdManga200DataItemStats = {
  /**
   * Total number of visible comments for the manga.
   * @minimum 0
   * @maximum 9007199254740991
   */
  commentCount: number;
  /**
   * Total accumulated chapter views for the manga.
   * @minimum 0
   * @maximum 9007199254740991
   */
  totalViews: number;
  /**
   * Total number of users who bookmarked the manga.
   * @minimum 0
   * @maximum 9007199254740991
   */
