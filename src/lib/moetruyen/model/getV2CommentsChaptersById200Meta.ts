 ...
 */
import type { GetV2CommentsChaptersById200MetaPagination } from "./getV2CommentsChaptersById200MetaPagination";

export type GetV2CommentsChaptersById200Meta = {
  /** @minLength 1 */
  requestId: string;
  /** @pattern ^(?:(?:\d\d[2468][048]|\d\d[13579][26]|\d\d0[48]|[02468][048]00|[13579][26]00)-02-29|\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\d|30)|(?:02)-(?:0[1-9]|1\d|2[0-8])))T(?:(?:[01]\d|2[0-3]):[0-5]\d(?::[0-5]\d(?:\.\d+)?)?(?:Z))$ */
  timestamp: string;
  pagination?: GetV2CommentsChaptersById200MetaPagination;
};
