 ...
 */
import type { GetV1TeamsByIdUpdates400ErrorDetails } from "./getV1TeamsByIdUpdates400ErrorDetails";

export type GetV1TeamsByIdUpdates400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1TeamsByIdUpdates400ErrorDetails;
};
