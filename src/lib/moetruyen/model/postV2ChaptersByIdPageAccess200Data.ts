 ...
 */
import type { PostV2ChaptersByIdPageAccess200DataPagesItem } from "./postV2ChaptersByIdPageAccess200DataPagesItem";

export type PostV2ChaptersByIdPageAccess200Data = {
  /**
   ...
   */
  maxWindow: number;
  pages: PostV2ChaptersByIdPageAccess200DataPagesItem[];
};
