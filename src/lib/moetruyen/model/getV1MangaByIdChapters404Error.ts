 ...
 */
import type { GetV1MangaByIdChapters404ErrorDetails } from "./getV1MangaByIdChapters404ErrorDetails";

export type GetV1MangaByIdChapters404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1MangaByIdChapters404ErrorDetails;
};
