 ...
 */
import type { GetV2CommentsMangaById400ErrorDetails } from "./getV2CommentsMangaById400ErrorDetails";

export type GetV2CommentsMangaById400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2CommentsMangaById400ErrorDetails;
};
