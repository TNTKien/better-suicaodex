 ...
 */
import type { GetV1UsersByUsername200DataTeam } from "./getV1UsersByUsername200DataTeam";

export type GetV1UsersByUsername200Data = {
  /** @minLength 1 */
  username: string;
   ...
   */
  commentCount: number;
  team: GetV1UsersByUsername200DataTeam;
};
