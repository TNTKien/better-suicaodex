 ...
 */
import type { GetV1CommentsMangaById200DataItemAuthor } from "./getV1CommentsMangaById200DataItemAuthor";
import type { GetV1CommentsMangaById200DataItemRepliesItem } from "./getV1CommentsMangaById200DataItemRepliesItem";

export type GetV1CommentsMangaById200DataItem = {
  /**
  ...
  /** @minLength 1 */
  commentPath: string;
  author: GetV1CommentsMangaById200DataItemAuthor;
  replies: GetV1CommentsMangaById200DataItemRepliesItem[];
};
