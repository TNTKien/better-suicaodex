 ...
 */
import type { GetV1SearchManga400ErrorDetails } from "./getV1SearchManga400ErrorDetails";

export type GetV1SearchManga400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1SearchManga400ErrorDetails;
};
