...
export type GetV1CommentsMangaByIdOrder =
  (typeof GetV1CommentsMangaByIdOrder)[keyof typeof GetV1CommentsMangaByIdOrder];

export const GetV1CommentsMangaByIdOrder = {
  asc: "asc",
  desc: "desc",
} as const;
