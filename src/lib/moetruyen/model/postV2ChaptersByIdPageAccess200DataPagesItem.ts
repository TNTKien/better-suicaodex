 ...
 */
import type { PostV2ChaptersByIdPageAccess200DataPagesItemGrant } from "./postV2ChaptersByIdPageAccess200DataPagesItemGrant";

export type PostV2ChaptersByIdPageAccess200DataPagesItem = {
  /**
   * @minimum 0
  ...
  storageKey: string;
  downloadUrl: string;
  grant: PostV2ChaptersByIdPageAccess200DataPagesItemGrant;
};
