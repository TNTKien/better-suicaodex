 ...
 */
import type { GetV1CommentsRecent400ErrorDetails } from "./getV1CommentsRecent400ErrorDetails";

export type GetV1CommentsRecent400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1CommentsRecent400ErrorDetails;
};
