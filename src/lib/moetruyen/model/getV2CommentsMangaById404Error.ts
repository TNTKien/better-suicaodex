 ...
 */
import type { GetV2CommentsMangaById404ErrorDetails } from "./getV2CommentsMangaById404ErrorDetails";

export type GetV2CommentsMangaById404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2CommentsMangaById404ErrorDetails;
};
