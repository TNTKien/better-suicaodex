 ...
 */
import type { GetV2CommentsChaptersById404ErrorDetails } from "./getV2CommentsChaptersById404ErrorDetails";

export type GetV2CommentsChaptersById404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2CommentsChaptersById404ErrorDetails;
};
