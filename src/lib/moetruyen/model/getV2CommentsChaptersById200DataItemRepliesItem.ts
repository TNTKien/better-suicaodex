 ...
 */
import type { GetV2CommentsChaptersById200DataItemRepliesItemAuthor } from "./getV2CommentsChaptersById200DataItemRepliesItemAuthor";

export type GetV2CommentsChaptersById200DataItemRepliesItem = {
  /**
  ...
  /** @minLength 1 */
  commentPath: string;
  author: GetV2CommentsChaptersById200DataItemRepliesItemAuthor;
};
