 ...
 */
import type { GetV1Manga200DataItemGenresItem } from "./getV1Manga200DataItemGenresItem";
import type { GetV1Manga200DataItemStatus } from "./getV1Manga200DataItemStatus";

export type GetV1Manga200DataItem = {
  /**
  ...
  author: string | null;
  status: GetV1Manga200DataItemStatus;
  cover: string | null;
  ...
  chapterCount: number;
  isOneshot: boolean;
  genres: GetV1Manga200DataItemGenresItem[];
};
