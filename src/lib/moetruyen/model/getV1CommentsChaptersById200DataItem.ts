...
export type GetV1CommentsChaptersById200DataItem = {
  /**
  ...
  /** @minLength 1 */
  commentPath: string;
  author: GetV1CommentsChaptersById200DataItemAuthor;
  replies: GetV1CommentsChaptersById200DataItemRepliesItem[];
};
