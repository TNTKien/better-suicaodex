 ...
 */
import type { GetV2ChaptersById404ErrorDetails } from "./getV2ChaptersById404ErrorDetails";

export type GetV2ChaptersById404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2ChaptersById404ErrorDetails;
};
