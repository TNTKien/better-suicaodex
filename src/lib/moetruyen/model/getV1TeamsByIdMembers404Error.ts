 ...
 */
import type { GetV1TeamsByIdMembers404ErrorDetails } from "./getV1TeamsByIdMembers404ErrorDetails";

export type GetV1TeamsByIdMembers404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1TeamsByIdMembers404ErrorDetails;
};
