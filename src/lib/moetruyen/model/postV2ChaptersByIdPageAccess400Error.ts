 ...
 */
import type { PostV2ChaptersByIdPageAccess400ErrorDetails } from "./postV2ChaptersByIdPageAccess400ErrorDetails";

export type PostV2ChaptersByIdPageAccess400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: PostV2ChaptersByIdPageAccess400ErrorDetails;
};
