 ...
 */
import type { GetV1TeamsByIdManga404Error } from "./getV1TeamsByIdManga404Error";
import type { GetV1TeamsByIdManga404Meta } from "./getV1TeamsByIdManga404Meta";

export type GetV1TeamsByIdManga404 = {
  success: false;
  error: GetV1TeamsByIdManga404Error;
  meta: GetV1TeamsByIdManga404Meta;
};
