 ...
 */
import type { GetV1CommentsChaptersByIdOrder } from "./getV1CommentsChaptersByIdOrder";

export type GetV1CommentsChaptersByIdParams = {
  /**
   ...
   */
  order?: GetV1CommentsChaptersByIdOrder;
};
