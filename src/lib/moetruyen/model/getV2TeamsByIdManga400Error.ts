 ...
 */
import type { GetV2TeamsByIdManga400ErrorDetails } from "./getV2TeamsByIdManga400ErrorDetails";

export type GetV2TeamsByIdManga400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2TeamsByIdManga400ErrorDetails;
};
