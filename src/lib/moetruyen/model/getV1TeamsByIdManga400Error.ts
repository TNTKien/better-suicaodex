 ...
 */
import type { GetV1TeamsByIdManga400ErrorDetails } from "./getV1TeamsByIdManga400ErrorDetails";

export type GetV1TeamsByIdManga400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1TeamsByIdManga400ErrorDetails;
};
