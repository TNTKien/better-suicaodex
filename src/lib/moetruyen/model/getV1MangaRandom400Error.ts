 ...
 */
import type { GetV1MangaRandom400ErrorDetails } from "./getV1MangaRandom400ErrorDetails";

export type GetV1MangaRandom400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1MangaRandom400ErrorDetails;
};
