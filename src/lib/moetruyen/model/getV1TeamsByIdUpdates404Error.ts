 ...
 */
import type { GetV1TeamsByIdUpdates404ErrorDetails } from "./getV1TeamsByIdUpdates404ErrorDetails";

export type GetV1TeamsByIdUpdates404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1TeamsByIdUpdates404ErrorDetails;
};
