 ...
 */
import type { GetV1UsersByUsernameComments400ErrorDetails } from "./getV1UsersByUsernameComments400ErrorDetails";

export type GetV1UsersByUsernameComments400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1UsersByUsernameComments400ErrorDetails;
};
