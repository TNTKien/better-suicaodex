...
export type GetV1MangaById200DataStatus =
  (typeof GetV1MangaById200DataStatus)[keyof typeof GetV1MangaById200DataStatus];

export const GetV1MangaById200DataStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
