...
export type GetV1MangaRandom200DataItemStatus =
  (typeof GetV1MangaRandom200DataItemStatus)[keyof typeof GetV1MangaRandom200DataItemStatus];

export const GetV1MangaRandom200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
