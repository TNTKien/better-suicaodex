 ...
 */
export type GetV1Manga200DataItemStatus =
  (typeof GetV1Manga200DataItemStatus)[keyof typeof GetV1Manga200DataItemStatus];

export const GetV1Manga200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
