 ...
 */
import type { GetV1ChaptersById404ErrorDetails } from "./getV1ChaptersById404ErrorDetails";

export type GetV1ChaptersById404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1ChaptersById404ErrorDetails;
};
