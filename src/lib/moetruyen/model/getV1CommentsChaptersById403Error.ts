 ...
 */
import type { GetV1CommentsChaptersById403ErrorDetails } from "./getV1CommentsChaptersById403ErrorDetails";

export type GetV1CommentsChaptersById403Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1CommentsChaptersById403ErrorDetails;
};
