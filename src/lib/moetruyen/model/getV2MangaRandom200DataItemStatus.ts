 ...
 */
export type GetV2MangaRandom200DataItemStatus =
  (typeof GetV2MangaRandom200DataItemStatus)[keyof typeof GetV2MangaRandom200DataItemStatus];

export const GetV2MangaRandom200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
