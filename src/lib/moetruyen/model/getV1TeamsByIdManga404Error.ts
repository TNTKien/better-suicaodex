 ...
 */
import type { GetV1TeamsByIdManga404ErrorDetails } from "./getV1TeamsByIdManga404ErrorDetails";

export type GetV1TeamsByIdManga404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1TeamsByIdManga404ErrorDetails;
};
