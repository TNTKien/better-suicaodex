 ...
 */
import type { GetV1TeamsByIdMangaSort } from "./getV1TeamsByIdMangaSort";
import type { GetV1TeamsByIdMangaStatus } from "./getV1TeamsByIdMangaStatus";

export type GetV1TeamsByIdMangaParams = {
  /**
  ...
  q?: string;
  /**
   * Legacy v1 team-manga genre filter. Accepts a genre name, not a genre id.
   * @maxLength 100
   */
  genre?: string;
  /**
