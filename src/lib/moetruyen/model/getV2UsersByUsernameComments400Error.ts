 ...
 */
import type { GetV2UsersByUsernameComments400ErrorDetails } from "./getV2UsersByUsernameComments400ErrorDetails";

export type GetV2UsersByUsernameComments400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2UsersByUsernameComments400ErrorDetails;
};
