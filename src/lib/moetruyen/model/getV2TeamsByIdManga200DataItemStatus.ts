 ...
 */
export type GetV2TeamsByIdManga200DataItemStatus =
  (typeof GetV2TeamsByIdManga200DataItemStatus)[keyof typeof GetV2TeamsByIdManga200DataItemStatus];

export const GetV2TeamsByIdManga200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
