 ...
 */
import type { GetV1MangaByIdChapters200DataChaptersItemAccess } from "./getV1MangaByIdChapters200DataChaptersItemAccess";

export type GetV1MangaByIdChapters200DataChaptersItem = {
  /**
