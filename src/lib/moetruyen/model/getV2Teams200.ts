 ...
 */
import type { GetV2Teams200DataItem } from "./getV2Teams200DataItem";
import type { GetV2Teams200Meta } from "./getV2Teams200Meta";

export type GetV2Teams200 = {
  success: true;
  data: GetV2Teams200DataItem[];
  meta: GetV2Teams200Meta;
};
