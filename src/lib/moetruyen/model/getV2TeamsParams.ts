 ...
 */
import type { GetV2TeamsSort } from "./getV2TeamsSort";

export type GetV2TeamsParams = {
  /**
  ...
  page?: number;
  /**
   * Maximum number of teams to return per page. Allowed range: `1` to `100`.
   * @minimum 1
   * @maximum 100
   */
  limit?: number;
  /**
   * Free-text search term matched against team name, slug, and intro.
   * @maxLength 100
   */
  q?: string;
  /**
   * Sort mode for the team list.
   */
  sort?: GetV2TeamsSort;
};
