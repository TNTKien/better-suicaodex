 ...
 */
export type GetV2Manga200DataItemStatus =
  (typeof GetV2Manga200DataItemStatus)[keyof typeof GetV2Manga200DataItemStatus];

export const GetV2Manga200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
