 ...
 */
import type { GetV2MangaByIdChaptersAggregate404ErrorDetails } from "./getV2MangaByIdChaptersAggregate404ErrorDetails";

export type GetV2MangaByIdChaptersAggregate404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2MangaByIdChaptersAggregate404ErrorDetails;
};
