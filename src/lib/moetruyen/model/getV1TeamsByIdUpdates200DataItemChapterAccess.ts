...
export type GetV1TeamsByIdUpdates200DataItemChapterAccess =
  (typeof GetV1TeamsByIdUpdates200DataItemChapterAccess)[keyof typeof GetV1TeamsByIdUpdates200DataItemChapterAccess];

export const GetV1TeamsByIdUpdates200DataItemChapterAccess = {
  public: "public",
