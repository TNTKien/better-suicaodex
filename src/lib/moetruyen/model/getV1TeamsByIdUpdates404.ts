 ...
 */
import type { GetV1TeamsByIdUpdates404Error } from "./getV1TeamsByIdUpdates404Error";
import type { GetV1TeamsByIdUpdates404Meta } from "./getV1TeamsByIdUpdates404Meta";

export type GetV1TeamsByIdUpdates404 = {
  success: false;
  error: GetV1TeamsByIdUpdates404Error;
  meta: GetV1TeamsByIdUpdates404Meta;
};
