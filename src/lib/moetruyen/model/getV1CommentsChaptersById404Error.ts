 ...
 */
import type { GetV1CommentsChaptersById404ErrorDetails } from "./getV1CommentsChaptersById404ErrorDetails";

export type GetV1CommentsChaptersById404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1CommentsChaptersById404ErrorDetails;
};
