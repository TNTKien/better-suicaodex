 ...
 */
import type { GetV1TeamsByIdMembers400ErrorDetails } from "./getV1TeamsByIdMembers400ErrorDetails";

export type GetV1TeamsByIdMembers400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1TeamsByIdMembers400ErrorDetails;
};
