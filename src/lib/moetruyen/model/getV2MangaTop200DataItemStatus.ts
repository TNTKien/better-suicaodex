 ...
 */
export type GetV2MangaTop200DataItemStatus =
  (typeof GetV2MangaTop200DataItemStatus)[keyof typeof GetV2MangaTop200DataItemStatus];

export const GetV2MangaTop200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
