 ...
 */
import type { GetV2MangaRandom400ErrorDetails } from "./getV2MangaRandom400ErrorDetails";

export type GetV2MangaRandom400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2MangaRandom400ErrorDetails;
};
