...
export type GetV2SearchMangaParams = {
  /**
   * Search term matched against manga title, slug, and aliases.
   * @minLength 1
   * @maxLength 100
   */
  q: string;
  /**
   * Maximum number of search results to return. Allowed range: `1` to `20`.
   * @minimum 1
   * @maximum 20
   */
  limit?: number;
