 ...
 */
import type { GetV1CommentsChaptersById200DataItemRepliesItemAuthor } from "./getV1CommentsChaptersById200DataItemRepliesItemAuthor";

export type GetV1CommentsChaptersById200DataItemRepliesItem = {
  /**
  ...
  /** @minLength 1 */
  commentPath: string;
  author: GetV1CommentsChaptersById200DataItemRepliesItemAuthor;
};
