 ...
 */
import type { GetV2TeamsByIdMembers404ErrorDetails } from "./getV2TeamsByIdMembers404ErrorDetails";

export type GetV2TeamsByIdMembers404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2TeamsByIdMembers404ErrorDetails;
};
