 ...
 */
import type { GetV2TeamsByIdManga404ErrorDetails } from "./getV2TeamsByIdManga404ErrorDetails";

export type GetV2TeamsByIdManga404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2TeamsByIdManga404ErrorDetails;
};
