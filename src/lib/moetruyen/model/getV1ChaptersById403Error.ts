 ...
 */
import type { GetV1ChaptersById403ErrorDetails } from "./getV1ChaptersById403ErrorDetails";

export type GetV1ChaptersById403Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1ChaptersById403ErrorDetails;
};
