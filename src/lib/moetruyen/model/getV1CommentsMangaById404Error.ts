 ...
 */
import type { GetV1CommentsMangaById404ErrorDetails } from "./getV1CommentsMangaById404ErrorDetails";

export type GetV1CommentsMangaById404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1CommentsMangaById404ErrorDetails;
};
