 ...
 */
import type { GetV1UsersByUsername404ErrorDetails } from "./getV1UsersByUsername404ErrorDetails";

export type GetV1UsersByUsername404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1UsersByUsername404ErrorDetails;
};
