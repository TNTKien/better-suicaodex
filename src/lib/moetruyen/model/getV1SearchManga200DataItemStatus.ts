...
export type GetV1SearchManga200DataItemStatus =
  (typeof GetV1SearchManga200DataItemStatus)[keyof typeof GetV1SearchManga200DataItemStatus];

export const GetV1SearchManga200DataItemStatus = {
  ongoing: "ongoing",
  completed: "completed",
  hiatus: "hiatus",
  cancelled: "cancelled",
