 ...
 */
import type { GetV1CommentsMangaById400ErrorDetails } from "./getV1CommentsMangaById400ErrorDetails";

export type GetV1CommentsMangaById400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV1CommentsMangaById400ErrorDetails;
};
