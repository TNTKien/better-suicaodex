 ...
 */
import type { GetV2TeamsByIdUpdates400ErrorDetails } from "./getV2TeamsByIdUpdates400ErrorDetails";

export type GetV2TeamsByIdUpdates400Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2TeamsByIdUpdates400ErrorDetails;
};
