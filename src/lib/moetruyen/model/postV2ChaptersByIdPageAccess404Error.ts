 ...
 */
import type { PostV2ChaptersByIdPageAccess404ErrorDetails } from "./postV2ChaptersByIdPageAccess404ErrorDetails";

export type PostV2ChaptersByIdPageAccess404Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: PostV2ChaptersByIdPageAccess404ErrorDetails;
};
