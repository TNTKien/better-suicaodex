 ...
 */
import type { GetV1CommentsMangaById200DataItemRepliesItemAuthor } from "./getV1CommentsMangaById200DataItemRepliesItemAuthor";

export type GetV1CommentsMangaById200DataItemRepliesItem = {
  /**
  ...
  /** @minLength 1 */
  commentPath: string;
  author: GetV1CommentsMangaById200DataItemRepliesItemAuthor;
};
