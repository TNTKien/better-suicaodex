 ...
 */
import type { GetV1UsersByUsername400Error } from "./getV1UsersByUsername400Error";
import type { GetV1UsersByUsername400Meta } from "./getV1UsersByUsername400Meta";

export type GetV1UsersByUsername400 = {
  success: false;
  error: GetV1UsersByUsername400Error;
  meta: GetV1UsersByUsername400Meta;
};
