 ...
 */
import type { GetV2CommentsChaptersById403ErrorDetails } from "./getV2CommentsChaptersById403ErrorDetails";

export type GetV2CommentsChaptersById403Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: GetV2CommentsChaptersById403ErrorDetails;
};
