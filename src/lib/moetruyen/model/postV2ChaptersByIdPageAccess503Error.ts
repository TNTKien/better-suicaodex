 ...
 */
import type { PostV2ChaptersByIdPageAccess503ErrorDetails } from "./postV2ChaptersByIdPageAccess503ErrorDetails";

export type PostV2ChaptersByIdPageAccess503Error = {
  /** @minLength 1 */
  code: string;
  /** @minLength 1 */
  message: string;
  details?: PostV2ChaptersByIdPageAccess503ErrorDetails;
};
