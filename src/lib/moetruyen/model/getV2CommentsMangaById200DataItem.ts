 ...
 */
import type { GetV2CommentsMangaById200DataItemAuthor } from "./getV2CommentsMangaById200DataItemAuthor";
import type { GetV2CommentsMangaById200DataItemRepliesItem } from "./getV2CommentsMangaById200DataItemRepliesItem";

export type GetV2CommentsMangaById200DataItem = {
  /**
  ...
  /** @minLength 1 */
  commentPath: string;
  author: GetV2CommentsMangaById200DataItemAuthor;
  replies: GetV2CommentsMangaById200DataItemRepliesItem[];
};
