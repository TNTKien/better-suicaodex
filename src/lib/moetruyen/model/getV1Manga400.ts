 ...
 */
import type { GetV1Manga400Error } from "./getV1Manga400Error";
import type { GetV1Manga400Meta } from "./getV1Manga400Meta";

export type GetV1Manga400 = {
  success: false;
  error: GetV1Manga400Error;
  meta: GetV1Manga400Meta;
};
