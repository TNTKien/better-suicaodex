...
export interface paths {
    ...
    "/manga/{id}/recommendation": {
        ...
        get: operations["get-manga-recommendation"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/manga/{id}/list/{listId}": {
        parameters: {
            query?: {
                /** @description Sort manga relationship entries in ascending order by */
                order?: number;
            };
            header?: never;
            path: {
...
export interface components {
    schemas: {
        ...
        /** MangaRecommendationList */
        MangaRecommendationList: {
            /** @default ok */
            result: string;
            /** @default collection */
            response: string;
            data?: components["schemas"]["MangaRecommendation"][];
            limit?: number;
            offset?: number;
            total?: number;
        };
        ...
        MangaRelationCreate: components["schemas"]["MangaRelationRequest"] & unknown;
        ...
        CommitUploadSession: {
            ...
            pageOrder?: string[];
            /** @description mandatory on chapter upload, refer to terms at https://mangadex.org/compliance */
         ...
         */
        ReferenceExpansionManga: ("manga" | "cover_art" | "author" | "artist" | "tag" | "creator")[];
        /**
        ...
        /**
         * ReferenceExpansionMangaRecommendation
         * @description Reference expansion options
         */
        ReferenceExpansionMangaRecommendation: "manga"[];
        /**
...
export interface operations {
    ...
    "get-search-manga": {
        parameters: {
            query?: {
                ...
                hasUnavailableChapters?: "0" | "1" | "true" | "false";
                group?: string;
            };
            header?: never;
            path?: never;
    ...
    "get-manga-recommendation": {
        parameters: {
            query?: {
                "includes[]"?: components["schemas"]["ReferenceExpansionMangaRecommendation"];
                order?: {
                    /** @enum {string} */
                    score?: "asc" | "desc";
                };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["MangaRecommendationList"];
                };
            };
        };
    };
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        result: string;
                        statuses?: {
                            [key: string]: "reading" | "on_hold" | "plan_to_read" | "dropped" | "re_reading" | "completed";
                        };
                    };
                };
            };
